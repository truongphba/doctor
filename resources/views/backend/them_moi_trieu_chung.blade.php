    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <div class="main-card mb-3 card">
                <div class="card-body">
                    <form id="signupForm" class="col-md-10 mx-auto" method="post" action="{{route('symptoms.store')}}" novalidate="novalidate">
                        {{csrf_field()}}
                        <div class="form-group">
                            <label>Tên bộ phận</label>
                            <div>
                                <select class="form-control text-center" name="location_id">
                                    <option style="text-align: center" readonly="true">Chọn bộ phận</option>
                                    @foreach($locations as $location)
                                        <option style="text-align: center" value="{{$location->id}}">{{$location->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" name="name" class="form-control" placeholder="Tên triệu chứng">
                            </div>
                        </div>
                        <div class="form-group">
