    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <div class="main-card mb-3 card">
                <div class="card-body">
                    <form id="signupForm" class="col-md-10 mx-auto" method="post" action="{{route('locations.update', $location)}}" novalidate="novalidate">
                        @method('PUT')
                        {{csrf_field()}}
                        <div class="form-group">
                            <label >Tên bộ phận</label>
                            <div>
                                <input type="text" class="form-control" name="name" placeholder="Tên bộ phận" value="{{$location->name}}">
                            </div>
                        </div>
                        <div class="form-group">
