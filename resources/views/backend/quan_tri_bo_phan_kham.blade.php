            ...
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>Quản trị bộ phận khám
                            <div class="page-title-subheading">
                            </div>
                        </div>
                    </div>
                    <div class="page-title-actions">
                        <a href="{{route('locations.create')}}"><button class="btn btn-success">Thêm mới</button></a>
                    </div>
                </div>
            </div>
                                ...
                                <table style="width: 100%;"
                                    ...
                                    @foreach($locations as $location)
                                        <tr role="row" class="even">
                                            ...
                                            <td>{{$location->name}}</td>
                                            <td class="text-center"><a href="{{route('locations.edit', $location)}}"><button class="btn btn-outline-warning">Sửa
                                                    </button></a></td>
