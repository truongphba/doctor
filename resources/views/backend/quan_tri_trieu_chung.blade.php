                                ...
                                <table style="width: 100%;"
                                    ...
                                    @foreach($symptoms as $symptom)
                                        <tr role="row" class="even">
                                            ...
                                            <td>{{$symptom->location_name}}</td>
                                            <td>{{$symptom->name}}</td>
                                            <td class="text-center"><a href="{{route('symptoms.edit', $symptom->id)}}">
                                                    <button class="btn btn-outline-warning">Sửa
                                                    </button>
                                                </a></td>
                                            <td class="text-center">
                                               <form method="post" action="{{route('symptoms.destroy', $symptom->id)}}">
                                                   @method('DELETE')
                                                   {{csrf_field()}}
                                                   <button class="btn btn-outline-danger" type="submit">Xóa
                                                   </button>
                                               </form>
                                            </td>
                                        </tr>
                                ...
                                <div class="dataTables_paginate paging_simple_numbers" id="example_paginate">
                                    <ul class="pagination">
                                        ...
                                        <li class="paginate_button page-item next disabled" id="example_next"><a
                                                href="#" aria-controls="example" data-dt-idx="1" tabindex="0"
