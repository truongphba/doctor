    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <div class="main-card mb-3 card">
                <div class="card-body">
                    <form id="signupForm" class="col-md-10 mx-auto" method="post" action="{{route('symptoms.update', $symptom)}}" novalidate="novalidate">
                        @method('PUT')
                        {{csrf_field()}}
                        <div class="form-group">
                            <label >Tên bộ phận</label>
                            <div>
                                <select class="form-control text-center" name="location_id">
                                    <option style="text-align: center">Chọn bộ phận</option>
                                    @foreach($locations as $location)
                                        <option style="text-align: center" value="{{$location->id}}" {{($symptom->location_id === $location->id) ? 'selected' : ''}}>{{$location->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" name="name" class="form-control" placeholder="Tên triệu chứng" value="{{$symptom->name}}">
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="drawer-section">
                        ...
                        <div class="mt-3"><h5 class="text-center card-title">Live Statistics</h5>
                            ...
                            <div class="text-center mt-2 d-block">
                                <button class="mr-2 border-0 btn-transition btn btn-outline-danger">Escalate Issue
                                </button>
                                <button class="border-0 btn-transition btn btn-outline-success">Support Center
                                </button>
                            </div>
                        </div>
                    </div>
                                ...
                                <li class="pt-2 pb-2 pr-2 list-group-item">
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            ...
                                            <div class="widget-content-left">
                                                <div class="widget-heading font-weight-normal">Latest_photos.zip
                                                </div>
                                            </div>
                                            <div class="widget-content-right widget-content-actions">
                                                <button class="btn-icon btn-icon-only btn btn-link btn-sm">
                        ...
                        <div class="notifications-box">
                            <div class="vertical-time-simple vertical-without-time vertical-timeline vertical-timeline--one-column">
                                ...
                                <div class="vertical-timeline-item dot-warning vertical-timeline-element">
                                    <div><span class="vertical-timeline-element-icon bounce-in"></span>
                                        <div class="vertical-timeline-element-content bounce-in"><p>Yet another one,
                                                at <span class="text-success">15:00 PM</span></p><span
                                                class="vertical-timeline-element-date"></span></div>
                                    </div>
                                </div>
                                        ...
                                        <div class="vertical-timeline-element-content bounce-in">
                                            <h4 class="timeline-title">Something not important
                                                <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                                    ...
                                                    <div class="avatar-icon-wrapper avatar-icon-sm">
                                                        <div class="avatar-icon"><img
                                                                src="/backend/assets/images/avatars/6.jpg"
                                                                alt=""></div>
                                                    </div>
                                                    <div class="avatar-icon-wrapper avatar-icon-sm">
                                                        <div class="avatar-icon"><img
                                ...
                                <div class="vertical-timeline-item dot-info vertical-timeline-element">
                                    <div><span class="vertical-timeline-element-icon bounce-in"></span>
                                        <div class="vertical-timeline-element-content bounce-in"><h4
                                                class="timeline-title">This dot has an info state</h4><span
                                                class="vertical-timeline-element-date"></span></div>
                                    </div>
                                </div>
                                <div class="vertical-timeline-item dot-dark vertical-timeline-element">
                                    <div><span class="vertical-timeline-element-icon is-hidden"></span>
                                        <div class="vertical-timeline-element-content is-hidden"><h4
                                                class="timeline-title">This dot has a dark state</h4><span
                                                class="vertical-timeline-element-date"></span></div>
                                    </div>
                                </div>
                            </div>
        ...
        <script type="text/javascript" src="/backend/assets/scripts/main.87c0748b313a1dda75f5.js"></script>
    @endsection
